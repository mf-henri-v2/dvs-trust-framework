...
11.1.a. When doing anything related to the trust framework, you must not bring the trust framework into disrepute or damage its reputation, optics or trustworthiness. You must check your legal obligations carefully and must always act lawfully.

11.1.b. You must not state or imply that your service(s) or organisation are endorsed by the government, DSIT or OfDIA. You also must not state or imply that you have a relationship with the government that you do not have. This includes through the misuse of logos, for example through the use of departmental logos, coat of arms, or Crown branding. These may also be subject to Crown copyright.

11.1.c. You must not misrepresent the certification status of service(s) you offer or allow others you work with to misrepresent their services through reliance on your certificate(s). For example, if you offer more than one service, you must be clear which of the services you offer have been certified and which have not. Similarly, you must not allow a third party to claim that they offer a certified service solely because some aspects of it are delivered by your certified service. This does not preclude the third party from disclosing that a certified service forms part of their supply chain, particularly where the certified service is conducting specific activities in line with regulatory requirements.

11.1.d. You must evidence that:

- your organisation is a legitimate entity, for example, by supplying your Companies House registration number, Charities Commission registration number, Data Universal Numbering System (DUNs) number, Legal Entity Identifier (LEI) or other information that identifies your organisation as a registered entity in the UK or another jurisdiction;

- your director(s), or equivalent depending on your legal status, does not have any restrictions or constraints inhibiting their ability to carry out their duties, such as outstanding bankruptcy proceedings or court summons;

- your organisation (and parent company if applicable), ultimate beneficial owners, director(s) and [people with significant control](https://www.gov.uk/guidance/people-with-significant-control-pscs), or equivalent depending on your legal status, do not appear on a [UK Sanctions List](https://www.gov.uk/government/publications/the-uk-sanctions-list);
...
- your organisation does not have any convictions or pending sanctions cases relating to corruption, bribery, money laundering, terrorism financing or fraud as defined in law such as the [Money Laundering Regulations (2017)](https://www.legislation.gov.uk/uksi/2017/692/contents), and the [Fraud Act (2006)](https://www.legislation.gov.uk/ukpga/2006/35/contents).

11.1.e. You must declare to your CAB and OfDIA any ICO investigations into your organisation that are relevant to your service. If any concerns are or have been raised by the ICO, you must provide evidence of how you have responded, or are in the process of responding, to OfDIA. For example, you may have made changes to your service design as a result.

11.1.f. If you are involved in or considering an acquisition or other trigger event covered by the [National Security and Investment Act 2021](https://www.gov.uk/government/collections/national-security-and-investment-act), you may need to notify the government and get approval before you can complete it. For further information you could consult [the guidance on GOV.UK](https://www.gov.uk/government/collections/national-security-and-investment-act). You must also evidence that you and the acquirer will continue to follow the trust framework and any other conditions of your trust framework certification.

<a id="section-11_2"></a>

### 11.2. Responding to complaints and disputes

11.2.a. You must have documented processes for dealing with complaints and disputes, whether these involve users or other participants in the trust framework.
...
11.2.c. Your complaints and disputes procedures must take account of relevant regulatory channels. You must also retain records of any complaints or disputes in line with your information management system and provide OfDIA or your CAB with information about complaints if requested.
...
- following equivalent industry standards such as the [National Cyber Security Centre (NCSC) Cyber Assessment Framework (CAF)](https://www.ncsc.gov.uk/collection/caf), or the [National Institute of Standards and Technology (NIST) Cybersecurity Framework](https://www.nist.gov/cyberframework); and/or

- following [BS7858](https://knowledge.bsigroup.com/products/screening-of-individuals-working-in-a-secure-environment-code-of-practice?version=standard) on screening individuals.
...
11.4.a. You must have service and quality management processes in place that cover all areas of your organisation that are covered by the trust framework. Your service and quality management process could be set out in a collection of documents that describe your organisation’s objectives and explain how you will achieve them.
...
11.4.c. The trust framework does not mandate certification to any particular standards to meet your objectives. You could follow a recognised industry standard, such as [ISO 9001](https://www.iso.org/standard/62085.html), [ISO/IEC 20000](https://www.iso.org/standard/70636.html) or the [Information Technology Information Library (ITIL)](https://www.itil.org.uk/what-is-itil). Depending on which sector you operate in, you could also follow [Six Sigma](https://www.sixsigma-institute.org/What_Is_Six_Sigma.php).

11.4.d. You must have policies or documentation that describe how you approach service management in areas such as:
...
11.5.a. Your organisation must have an information management system that follows industry standards, such as [ISO/IEC 27001](https://www.iso.org/standard/27701) and the [ISO/IEC 27701](https://www.iso.org/standard/71670.html) extension. If you do not follow these standards, you must still ensure your information management system meets the criteria detailed in this section.
...
- how you share information (including why it is shared, who it is shared with, how often it is shared, what format it is in and how it is protected);

- how long you retain and how you protect data; and

- how you archive information.

<a id="section-11_5_1"></a>
...
11.6.a. Information security incorporates cyber security as well as broader security considerations. You must have an information security management system that follows an industry standard, such as [ISO/IEC 27001](https://www.iso.org/isoiec-27001-information-security.html), and complies with requirements in UK data protection legislation. If you do not follow this standard, you must still ensure your information security management system meets the criteria detailed in this section. This must ensure your organisation can control and evaluate how you handle data when it is stored, transmitted or otherwise processed.

11.6.b. Your information security management system must be based on the principles of the ‘CIA Triad’:

- confidentiality ([11.6.1](#section-11_6_1)), which involves preserving authorised restrictions on information access and disclosure, including means for protecting personal privacy and proprietary information;

- integrity ([11.6.2](#section-11_6_2)), which involves guarding against improper information modification or destruction and ensuring information non-repudiation and authenticity; and

- availability ([11.6.3](#section-11_6_3)), which involves ensuring timely and reliable access to and use of information.
...
11.6.d. [NCSC guidance on building and operating a secure online service](https://www.ncsc.gov.uk/guidance/building-operating-secure-online-service) can support you in the development of your information security management system.

11.6.e. You could also conform with and be certified against [Cyber Essentials or Cyber Essentials Plus](https://www.ncsc.gov.uk/cyberessentials/overview).

<a id="section-11_6_1"></a>
...
- make regular backups and prepare recovery plans;

- maintain data versioning and timestamps;

- keep audit trails and logs and protect them; and

- implement error handling mechanisms.

<a id="section-11_6_3"></a>
...
- protect information and technology when they are accessed from a remote location (e.g. outside of the usual place of work).

<a id="section-11_6_7"></a>
...
11.6.9.d. You could follow ICO [guidance on data security](https://ico.org.uk/for-organisations/uk-gdpr-guidance-and-resources/security/a-guide-to-data-security/) to help you implement security measures appropriate to the risks to your service. 
...
- [ISO/IEC 27005](https://www.iso.org/standard/80585.html); or
...
- identify risks to your users, which could include [phishing attacks](https://www.ncsc.gov.uk/guidance/phishing), man in the middle attacks and imposter attacks;
...
11.7.c. You could use [NCSC guidance on cyber security-related risk management](https://www.ncsc.gov.uk/collection/risk-management-collection) to develop your risk management framework.
...
11.7.e. If you provide your service to another certified service (for example, if you are a component service providing certified components to other certified services), then your risk management framework must cover how potential failures or interruptions in your service could impact other services and their certification status. You must have a documented procedure to support those other certified services to handle risks of potential failures or interruptions in your service on their certified service via your contracts and account for supply chain frailty.

11.7.f. If your service depends on other digital verification services, then your risk management framework must cover how potential failures or interruptions to those other services could impact your service and certification status. You must have a documented procedure for handling risks via your contracts and account for supply chain frailty.

<a id="section-11_8"></a>

### 11.8. Keeping records

11.8.a. You must record what your service did to create, manage, share or consume a digital identity or attribute. You must do this in a way that meets the requirements in [Article 30 of the UK GDPR](https://ico.org.uk/for-organisations/uk-gdpr-guidance-and-resources/accountability-and-governance/documentation/what-do-we-need-to-document-under-article-30-of-the-gdpr/).
...
<a id="section-11_8_3"></a>

#### 11.8.3. Disposing of records

11.8.3.a. Your organisation must have clear, documented rules on how long to keep records for, in line with ICO guidance on [retention policies](https://ico.org.uk/for-organisations/uk-gdpr-guidance-and-resources/data-protection-principles/a-guide-to-the-data-protection-principles/storage-limitation/), to assist in demonstrating compliance with the storage limitation principle set out in the UK GDPR. When you no longer need information, you must dispose of it in a safe and secure way. Before you decide whether to keep or dispose of a record, you must consider whether you may need it for:
...
11.8.3.b. You might need to keep just part of the record. For example, a provider conducting age verification checks might retain the fact that they have completed a successful check that a user meets an age threshold, but not retain the data used to complete that check.

<a id="section-11_8_4"></a>
...
- what they must do to comply with data protection legislation and (if your organisation is a public authority) the [Freedom of Information Act (2000)](https://www.legislation.gov.uk/ukpga/2000/36/contents) or where relevant, the [Freedom of Information (Scotland) Act (2002)](https://www.legislation.gov.uk/asp/2002/13/contents). For more information, see the [ICO guidance on freedom of information requests](https://ico.org.uk/for-organisations/foi/).

<a id="section-11_8_6"></a>
...
11.9.a. In case your service no longer has a valid trust framework certificate or is removed from the register, you must demonstrate you have a transition plan and policies to:

- notify all users of your product or service;

- notify any relying parties that consume identities and/or attributes you have created;

- notify other DVS you provide your service to; and
...
- provide users, other services you work with and relying parties with a reasonable period of time to migrate to other providers;

- provide your CAB with time to reflect this in your certification and, where relevant, the certification of other DVS you provide your service to;

- provide OfDIA with time to update the register; and
...
[← Previous: 10. Inclusivity, accessibility and service design](10-inclusivity-accessibility-and-service-design.md) · [Part README](README.md) · [Trust Framework 1.0](../README.md) · [Repository home](../../README.md) · [Next: 12. Service requirements →](12-service-requirements.md)
